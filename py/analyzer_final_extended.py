...
for index, project in enumerate(projects_list):
    loose_file = open(f"./output-loose-extended/{project}_analyzer.json")
    strict_file = open(f"./output-strict-extended/{project}_analyzer.json")
...
f = open("./final_analyzer_extended.json", "w")
